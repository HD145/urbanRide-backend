...
import com.urbanride.dto.AuthRequest;
import com.urbanride.dto.AuthResponse;
import com.urbanride.dto.UserRegistrationRequest;
...
import com.urbanride.util.JwtTokenUtil;
...
public class AuthController {
    ...
    public ResponseEntity<?> authenticateUser(@Valid @RequestBody AuthRequest authRequest) {
        System.out.println("Came to login endpoint with username: " + authRequest.getUsername());
